  ...
  {  if(request.getParameter("ques").equals(e.getQuestion())) 
	{
      %>
		<tr  class="table-primary">
			<form action="../Update/updatequestionnow.jsp">
...
<th colspan="4"  ><center><input type="button" class="btn btn-outline-success" value="Add Question" onclick="location.href='../Add/AddQuestion.jsp'"></center></th>
