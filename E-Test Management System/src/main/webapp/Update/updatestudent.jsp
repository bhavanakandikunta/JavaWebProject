  ...
  {  if(request.getParameter("username").equals(e.getUsername())) 
	{
      %>
		<tr  class="table-primary">
			<form action="../Update/updatestudentnow.jsp">
   ...
   <%
    ...
    %>
<tr>
<th colspan="2"><center><input type="button" class="btn btn-outline-success" value="Add Student" onclick="location.href='Add/AddStudent.jsp'"></center></th>
